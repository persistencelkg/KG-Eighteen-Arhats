...
public class AntPathMatcher {
    ...
    public boolean match(String pattern, String path) {
        if (Objects.equals(pattern, path)) {
            return true;
        }
    ...
    protected String[] tokenizePath(String path) {
        return this.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens);
    }
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = this.tokenizeToStringArray(pattern, this.pathSeparator, this.trimTokens);
        String[] pathParts = this.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens);
    ...
    public static void main(String[] args){
        ...
        System.out.println(matcher.match("jvm.**.test","jvm.free.api.test"));
        System.out.println(matcher.match("jvm.*","jvm.free"));
    }
}
