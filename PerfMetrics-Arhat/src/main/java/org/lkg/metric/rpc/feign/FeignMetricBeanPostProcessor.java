...
public class FeignMetricBeanPostProcessor implements BeanPostProcessor {
    ...
    public FeignMetricBeanPostProcessor(ObjectProvider<SelfFeignInterceptor> selfFeignInterceptorObjectProvider, Environment environment) {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof FeignContext) {
            return new FeignContextDecorator(list, environment, ((FeignContext) bean));
        }
